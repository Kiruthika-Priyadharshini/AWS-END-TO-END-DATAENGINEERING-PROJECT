...
def create_initial_df():
    glue_dynamic_frame_initial = glueContext.create_dynamic_frame.from_catalog(database='scrappy-db', table_name='dirty_books_parquet')
...
s3output = glueContext.getSink(
  path="s3://demo-parquet-bucket-1/clean_books_parquet",
  connection_type="s3",
...
s3output.setCatalogInfo(
  catalogDatabase="scrappy-db", catalogTableName="clean_books_parquet"
)
